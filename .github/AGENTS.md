# GitHub maintenance guidance

This file supplements the repository-wide agent and code-review rules for
...
- Preserve supported Linux, macOS arm64, and macOS Intel validation and stable
  check names suitable for repository rulesets.
